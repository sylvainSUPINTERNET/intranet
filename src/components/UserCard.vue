...
<template>
 ...
 " aria-hidden="true"></span> {{user.birthdate}} ()</p>
     <p class="card-text">    <span class="      glyphicon glyphicon-home
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                welcomMsg: 'Bienvenue sur l\'intranet',
                subMsg: 'la plateform social de l\'entreprise',
            }
        },
        methods:{
            remove(){
